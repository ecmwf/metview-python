...
Procedure and needed files::
    ...
    1) download and unpack of the Metview source-bundle "MetviewBundle-2017.05.0-Source.tar"
    ...
    6) the CMakeLists.txt file in the root directory of the bundle source to change
