...
.. container::
    ...
    .. container:: rightside
        ...
        This function performs the same task as the `Cross Section View <https://confluence.ecmwf.int/display/METV/Cross+Section+View>`_ icon in Metview’s user interface. It accepts its parameters as keyword arguments, described below.
