...
.. container::
    ...
    .. container:: rightside
        ...
        This function performs the same task as the `Symbol Plotting <https://confluence.ecmwf.int/display/METV/Symbol+Plotting>`_ icon in Metview’s user interface. It accepts its parameters as keyword arguments, described below.
...
.. py:function:: msymb(**kwargs)
    ...
    :param legend: Turn legend "on" or "off" ("on"/"off") : New Parameter!
    ...
    :param symbol_table_mode: Specifies if plotting is to be in "advanced", table ("on") or individual mode ("off").                    Note:  The simple table mode is not recommended anymore, try to use the "advanced" mode instead,                this  should give you easier control of the plot.
    :type symbol_table_mode: {"off", "advanced", "on"}, default: "off"


    :param symbol_format: Format used to plot values (MAGICS Format/("(automatic)"))
    :type symbol_format: str, default: "(automatic)"


    :param symbol_outline: Add an outline to each symbol
    ...
    :param symbol_outline_style: Line Style of outline
    :type symbol_outline_style: {"solid", "dash", "dot", "chain_dot", "chain_dash"}, default: "solid"


    :param symbol_connect_line: Connect all the symbols with a line
    :type symbol_connect_line: {"on", "off"}, default: "off"


    :param symbol_connect_automatic_line_colour: if "on", will use the colour of the symbol
    ...
    :param symbol_height: Height of symbols.
    :type symbol_height: number, default: 0.2


    :param symbol_marker_mode: Method to select a marker : by "name", by "index", by "image" : in that case, Magics will use an external "image" as marker.Method to select a marker : by "name", by "index", by "image" : in that case, Magics will use an external "image" as marker.
    :type symbol_marker_mode: {"index", "name", "image"}, default: "index"


    :param symbol_marker_index: Marker indice:  An integer between 1 and 28
    :type symbol_marker_index: int, default: 1


    :param symbol_marker_name: Symbol name. Choose in a list of available markers "dot"/circle/ww_00 ...
    ...
    :param symbol_advanced_table_selection_type: Technique to use to calculate the shading band levels.
    :type symbol_advanced_table_selection_type: {"count", "interval", "list"}, default: "count"


    :param symbol_advanced_table_min_value: Min value to plot
    :type symbol_advanced_table_min_value: number, default: -1.e21


    :param symbol_advanced_table_max_value: Max value to plot
    :type symbol_advanced_table_max_value: number, default: 1.e21


    :param symbol_advanced_table_level_count: Count or number of levels to be plotted. Magics will try to find "nice levels",            this means that the number of levels could be slightly different from the requested number of levels
    :type symbol_advanced_table_level_count: number, default: 10


    :param symbol_advanced_table_level_tolerance: Tolerance: Do not use "nice levels" if the number of levels is really to different [count +/- tolerance]
    :type symbol_advanced_table_level_tolerance: number, default: 2


    :param symbol_advanced_table_interval: Interval in data units between different bands of shading
    :type symbol_advanced_table_interval: number, default: 8.0


    :param symbol_advanced_table_reference_level: Level from which the level interval is calculated
    ...
    :param symbol_advanced_table_colour_method: Method of generating the colours of the bands in polygon shading
    :type symbol_advanced_table_colour_method: {"calculate", "list"}, default: "calculate"


    :param symbol_advanced_table_max_level_colour: Highest shading band colour
    :type symbol_advanced_table_max_level_colour: str, default: "blue"


    :param symbol_advanced_table_min_level_colour: Lowest shading band colour
    :type symbol_advanced_table_min_level_colour: str, default: "red"


    :param symbol_advanced_table_colour_direction: Direction of colour sequencing for plotting ("clockwise"/ ANTI_CLOCKWISE)
    ...
    :param symbol_advanced_table_colour_list_policy: What to do if the list of colours is smaller than the list of intervals: "lastone"/"cycle"
    ...
    :param symbol_advanced_table_marker_list_policy: What to do if  the list of markers is smaller than the list of intervals: "lastone"/"cycle"
    :type symbol_advanced_table_marker_list_policy: {"lastone", "cycle"}, default: "lastone"


    :param symbol_advanced_table_height_method: Method of generating the height
    ...
    :param symbol_advanced_table_height_min_value: Mininimum height to use
    ...
    :param symbol_advanced_table_height_list_policy: What to do if the list of heights is smaller than the list of intervals: "lastone"/"cycle"
    ...
    :param symbol_advanced_table_text_list_policy: What to do if  the list of text is smaller that the list of intervalslastone: reuse the last one,"cycle": return to the fisrt one
    ...
    :param symbol_advanced_table_text_font_colour: Symbol Colour
    :type symbol_advanced_table_text_font_colour: {"background", "automatic"}, default: "automatic"


    :param symbol_advanced_table_text_display_type: How to display text         "none":do not display it         "centre" : display it instead of the symbol,         "right" : attached it to the "right" of the symbol,         "top" : attached it to the "top" of the symbol,         "bottom":   attached it to the "bottom" of the symbol,
