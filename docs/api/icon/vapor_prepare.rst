...
.. py:function:: vapor_prepare(**kwargs)
    ...
    :type vapor_2d_params: str or list[str]
    ...
    :type vapor_3d_params: str or list[str]
    ...
    :type vapor_vertical_grid_type: str
    ...
    :type vapor_elevation_param: str
    ...
    :type vapor_bottom_coordinate: number
    ...
    :type vapor_top_coordinate: number
    ...
    :type vapor_area: float or list[float]
    ...
    :type vapor_grid: float or list[float]
    ...
    :type vapor_refinement_level: str
