...
.. container::
    ...
    .. container:: rightside
        ...
        This function performs the same task as the `Table Visualiser <https://confluence.ecmwf.int/display/METV/table+visualiser>`_ icon in Metview’s user interface. It accepts its parameters as keyword arguments, described below.
...
.. py:function:: table_visualiser(**kwargs)
    ...
    :type table_plot_type: {"xy_points", "geo_points", "xy_vectors", "geo_vectors", "xy_binning", "geo_binning"}, default: "xy_points"
    ...
    :type table_header_row: str, default: "1"


    :param table_data_row_offset: 
    :type table_data_row_offset: str, default: "1"
