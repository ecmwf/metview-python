...
Defines a PDF plot output driver.
...
.. py:function:: pdf_output(**kwargs)
    ...
    :param output_name_first_page_number: Determines whether for the first page the number is included in the filename.
    ...
    :param output_debug: Defines if extra debug information are written into the output.
