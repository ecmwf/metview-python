...
.. container::
    ...
    .. container:: rightside
        ...
        This function performs the same task as the `Stations <https://confluence.ecmwf.int/display/METV/stations>`_ icon in Metview’s user interface. It accepts its parameters as keyword arguments, described below.
...
.. py:function:: stations(**kwargs)
    ...
    :type position: float or list[float], default: 51.38
    ...
    :type area: float or list[float], default: 52
