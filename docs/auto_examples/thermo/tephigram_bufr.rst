.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_thermo_tephigram_bufr.py>`     to download the full example code
    .. rst-class:: sphx-glr-example-title

    .. _sphx_glr_auto_examples_thermo_tephigram_bufr.py:
...
.. image:: /auto_examples/thermo/images/sphx_glr_tephigram_bufr_001.png
    :alt: tephigram bufr
...
.. _sphx_glr_download_auto_examples_thermo_tephigram_bufr.py:
