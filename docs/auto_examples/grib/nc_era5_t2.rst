.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_grib_nc_era5_t2.py>`     to download the full example code
    .. rst-class:: sphx-glr-example-title

    .. _sphx_glr_auto_examples_grib_nc_era5_t2.py:
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/Users/sandor/git/mpy/docs/gallery/grib/nc_era5_t2.py", line 72, in <module>
...
.. _sphx_glr_download_auto_examples_grib_nc_era5_t2.py:
